...
const HELP_LINES: &[(&[&str], &[Kind])] = &[
    ...
    (&[], &[]),
    (&[" g ", " ", "Go to specific BS date"], &[Kind::Key, Kind::Body, Kind::Body]),
    (&[], &[]),
    (&[" 1-9 ", " ", "Jump to month (1-9)"], &[Kind::NavKey, Kind::Body, Kind::Body]),
    (&[], &[]),
    (&[" 0 ", " ", "Month 10-12 (then 1/2/3)"], &[Kind::NavKey, Kind::Body, Kind::Body]),
    (&[], &[]),
    (&["Actions"], &[Kind::Header]),
    (&[], &[]),
    ...
    (&[], &[]),
    (&[" Hover ", " ", "Preview AD date"], &[Kind::NavKey, Kind::Body, Kind::Body]),
    (&[], &[]),
